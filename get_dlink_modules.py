...
HOSTS = [
    ...
    {"hostname": "該当ホスト名_2", "ip": "該当IPアドレス_2"},
    {"hostname": "該当ホスト名_3", "ip": "該当IPアドレス_3"},
    {"hostname": "該当ホスト名_4", "ip": "該当IPアドレス_4"},
    {"hostname": "該当ホスト名_5", "ip": "該当IPアドレス_5"},
    {"hostname": "該当ホスト名_6", "ip": "該当IPアドレス_6"},
    {"hostname": "該当ホスト名_7", "ip": "該当IPアドレス_7"},
    {"hostname": "該当ホスト名_8", "ip": "該当IPアドレス_8"},
    {"hostname": "該当ホスト名_9", "ip": "該当IPアドレス_9"}
]
